...
const WebDeveloperPeterborough = () => {
  ...
  const offers = [
    ...
    },
    {
      ...
      description: "Dominate local search results and enhance your online presence in Peterborough.",
      icon: faSearch,
    },
    {
  ...
  const faq = [
    {
      q: "How much does a website cost in Peterborough?",
    ...
    },
    {
      ...
      a: "Absolutely. I implement technical SEO, structured data, page-speed improvements, and content targeting Peterborough and the Kawarthas.",
    },
  ];
  ...
  return (
    <div>
      ...
      <Helmet>
        <title>Web Developer Peterborough | Ironleaf Technology</title>
        <link
          rel="canonical"
          href="https://ironleaftechnology.com/web-developer-peterborough"
        />
        <meta
          name="description"
          content="Looking for a web developer in Peterborough, Ontario? Ironleaf Technology builds fast, SEO-friendly websites with ongoing support. Local and veteran-owned."
        />
        <meta
          name="keywords"
          content="web developer Peterborough, web development Peterborough, web design Peterborough, website developer in Peterborough, SEO Peterborough, small business websites Peterborough"
        />
      ...
      <section className="bg-gradient-to-br from-primary to-secondary text-white py-20 animate-fade-in relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto opacity-90 animate-slide-up" style={{ animationDelay: '0.2s' }}>
            ...
            Peterborough and the Kawarthas. I focus on performance, accessibility,
